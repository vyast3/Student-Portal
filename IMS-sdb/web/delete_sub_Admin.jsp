...
Connection con = DriverManager.getConnection( database ,"","");
 Statement st=con.createStatement(); rs = null;
           // s = (String) session.getAttribute("delId");
               ...
               String r = "delete from  subAdmin  where id='"+request.getParameter("id1")+"'";
                int i = st.executeUpdate(r);
                if (i > 0) {
                  out.println("<h1>Record Deleted Successfully</h1><br><a href=htmAdmin.jsp>Delete more records</a>");
                //   %><%
  //                  return;
              }
