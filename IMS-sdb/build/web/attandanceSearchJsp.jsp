...
<div>
     ...
     <table width="50%" border="2" cellspacing="1" align="center" class="tablegrid">
            <tr>
              <th  colspan="13" bgcolor="#E8F4BD"> Attandance: </th>
            </tr>
            <tr>
              <td width="16%" bgcolor="#C8F2C6"> Subject </td>
              <td width="16%" bgcolor="#C8F2C6"> Semester </td>
