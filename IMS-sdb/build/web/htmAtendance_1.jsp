...
<form id="form1" name="form1" method="post" action="atandance.jsp">
  <table width="505" border="1" align="center">
    ...
    <tr>
      ...
      <th scope="row">Semeater/Branch:</th>
      <td colspan="2"><input name="txtSem" type="text" id="txtSem" /></td>
    </tr>
    <tr>
      <th scope="row">.</th>
    ...
    <tr>
      <th width="42" scope="row">1</th>
      <th width="229" scope="row">Akash  </th>
      <td width="92"><input name="akash1" type="radio" value="p" />
P</td>
      <td width="114"><input name="akash1" type="radio" value="a" />
        A</td>
    </tr>
    <tr>
      <th scope="row">2</th>
