...
<form id="form1" name="form1" method="post" action="bookSerchjsp_1.jsp ">
  <table width="495" border="1" align="center" bordercolor="#1266F1" bgcolor="#E3E1FB">
    <tr>
      <th  colspan="2" scope="row">BOOK SEARCH : </th>
    </tr>
    <tr>
      <th width="207" scope="row">Enter Book Id / Name /Author : </th>
